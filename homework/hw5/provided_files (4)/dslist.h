...
#include <cassert> //http://www.cplusplus.com/reference/cassert/
/*
...
public:
  ...
  list_iterator<T>& operator++() { // pre-increment, e.g., ++iter //the operator for the list iterator as
      //declared as an object list_iterator<???dslist???>
    ptr_ = ptr_->next_;
    return *this;
  }
